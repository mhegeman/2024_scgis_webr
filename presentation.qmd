...
In the last few years we've started hearing about WebR which allows users to run R in the browser, with no installation required by the users. If you have a browser you can use it. 
:::
