...
format: 
  pptx: 
    reference-doc: 
      reference_slides.pptx
  revealjs:
    theme: moon
    transition: slide
    slide-number: true
    footer: 'SCGIS Annual Conference 2024 - https://github.com/mhegeman/2024_scgis_webr'
